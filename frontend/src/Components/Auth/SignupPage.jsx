...
function SignupForm() {
  ...
  const handleOnSubmit = (e) => {
    ...
    const signupFormData = { ...formData, role }
    dispatch(setSignupData(signupFormData))
    dispatch(signUp(name, email, password, confirmPassword, phone, role, navigate))
  ...
  const tabData = [
    { id: 1, tabName: "Donor", type: "donor" },
    { id: 2, tabName: "Volunteer", type: "volunteer" },
  ]
  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleOnSubmit} className="flex flex-col gap-y-4 w-full">
        ...
        <button
          type="submit"
          className="mt-6 w-full rounded bg-pink-200 py-3 text-richblack-900 font-semibold hover:bg-pink-300 transition"
        >
          Create Account
        </button>
      </form>
