  ...
  return (
    <div className="w-full bg-richblack-900">
      ...
      <section className="bg-richblack-700 overflow-hidden">
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center text-center text-white py-14 md:py-20 gap-10">
          <header className="text-2xl sm:text-3xl md:text-4xl font-semibold max-w-3xl">
            Driving Innovation in Food Donation and Volunteering for a
            <HighlightText text={" Brighter Future"} />
            <p className="mt-4 text-sm sm:text-base font-medium text-richblack-300">
              Feed Forward is at the forefront of driving innovation in food
              donation and volunteering. We're passionate about creating a
              brighter future by offering streamlined event creation, leveraging
              emerging technologies, and nurturing a vibrant community of givers
              and volunteers.
            </p>
          </header>

          {/* Image Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full max-w-4xl mt-10 mb-[-50px] z-10 relative">
            <img src={BannerImage1} alt="banner-1" className="w-full h-auto object-cover rounded-md" />
            <img src={BannerImage2} alt="banner-2" className="w-full h-auto object-cover rounded-md" />
            <img src={BannerImage3} alt="banner-3" className="w-full h-auto object-cover rounded-md" />
          </div>
        </div>
      </section>
      ...
      <section className="mt-24 px-4 md:px-0">
        <div className="mx-auto w-11/12 max-w-maxContent flex flex-col-reverse lg:flex-row items-center gap-12 text-richblack-500">
          <div className="flex flex-col gap-6 lg:w-1/2">
            <h1 className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-transparent text-2xl sm:text-3xl md:text-4xl font-semibold">
              Our Founding Story
            </h1>
            <p className="text-sm sm:text-base text-richblack-300">
              Our platform was born out of a shared vision and passion for transforming food donation and volunteer opportunities...
            </p>
            <p className="text-sm sm:text-base text-richblack-300">
              We believed that these efforts should not be confined to physical locations or restricted by logistical barriers...
            </p>
          </div>
          <div className="w-full lg:w-1/2">
            <img
              src={FoundingStory}
              alt="Founding Story"
              className="w-full h-auto object-cover rounded-md shadow-[0_0_20px_0] shadow-[#FC6767]"
            />
          </div>
        </div>
      </section>
      ...
      <section className="mt-20 px-4 md:px-0">
        <div className="mx-auto w-11/12 max-w-maxContent flex flex-col gap-14 lg:gap-10 lg:flex-row justify-between text-richblack-500">
          <div className="flex flex-col gap-6 lg:w-[45%]">
            <h1 className="bg-gradient-to-b from-[#FF512F] to-[#F09819] bg-clip-text text-transparent text-2xl sm:text-3xl md:text-4xl font-semibold">
              Our Vision
            </h1>
            <p className="text-sm sm:text-base text-richblack-300">
              With this vision in mind, we set out on a journey to create a platform that would revolutionize the way people engage in food donation and volunteering...
            </p>
          </div>
          <div className="flex flex-col gap-6 lg:w-[45%]">
            <h1 className="bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] bg-clip-text text-transparent text-2xl sm:text-3xl md:text-4xl font-semibold">
              Our Mission
            </h1>
            <p className="text-sm sm:text-base text-richblack-300">
              Our mission goes beyond just facilitating donations and volunteer events. We aim to create a vibrant community of givers and helpers...
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto mt-20 w-11/12 max-w-maxContent bg-richblack-700 py-10 px-4 sm:px-0">
        <LearningGrid />
      </section>
